...
public class NewAccountActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //View
        mEmailView = findViewById(R.id.Identifiant);
        mPasswordView = findViewById(R.id.MotDePasse);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent NewAccountIntent = new Intent(NewAccountActivity.this, MainActivity.class);
